function [hrv,hrv_time,ECGStress_Fit,stressTime_Regions,varargout] = ecgStressClassi_func(ECG_Cell,ecgTimestamps)
...
for ii=1:size(ECG_Cell,1)
    ...
    % % moving average cutoff frequency in 3.545 Hz. Cutoff at -3.01 dB
    % 
...
varargout{1} = ECG_Cell;
varargout{2} = ecgTimestamps;
varargout{3} = Fs;
